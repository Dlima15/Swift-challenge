...
## 📌 Casos de Uso  
1. **Avaliar Atendimento** – cliente usa QR code e gera pontos ao colaborador.  
2. **Atingir Meta Diária** – sistema registra pontos automáticos.  
3. **Subir de Nível** – funcionário desbloqueia recompensas.  
4. **Participar de Desafios** – desafios criados pelo admin com recompensas.  
